...
const Hero = () => {
  return (
    <>
      <div className=' w-[100%] md_tablet:flex-row flex-col-reverse sm_desktop:h-[55rem] md_tablet:h-[45rem] xl_phone:h-[110vh] lg_phone:h-[120vh] h-[95vh]  md_tablet:mt-[-5rem] mt-0 relative flex md_tablet:justify-between md_tablet:items-start items-center hero-gradient  z-10 ' >
