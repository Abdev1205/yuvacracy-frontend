...
const Hero = () => {
  return (
    <>
      <div className=' w-[100%] md_tablet:flex-row flex-col-reverse sm_desktop:h-[55rem] md_tablet:h-[45rem] lg_phone:h-[65rem] h-[95vh] md_tablet:mt-[-5rem] mt-0 relative flex md_tablet:justify-between md_tablet:items-start items-center hero-gradient  z-10 ' >
        <div className=' flex flex-col md_tablet:justify-center gap-[1rem] h-[100%] md_tablet:w-[50%] w-[100%] sm_desktop:mt-[2rem] mt-[2rem] md_tablet:ml-[5rem] ml-0 md_tablet:items-start items-center  ' >
        ...
        <div className=' md_tablet:mt-[2rem] lg_phone:mt-[6rem] mt-[5rem] relative md_tablet:w-[50%] w-[100%] md_tablet:h-[100%] h-auto flex flex-col justify-center md_tablet:items-end items-center' >
          <Image
            ...
            alt={'Logo'} height={1500} width={1500}
